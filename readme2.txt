...
στον server. Δημιουργεί πρώτα μια υποδοχή TCP και καθορίζει τη διεύθυνση του server. Στη συνέχεια 
...
επόμενη ψήφο περιμένοντας την επιβεβαίωση της προηγούμενης ψήφου από τον server.
